...
define(["jquery", "easy-admin"], function ($, ea) {
    ...
    var init = {
        ...
        index_url: 'mall.proshow/index?id=' + getUrlParam('id') + '&date=' + getUrlParam('date'),
        ...
        index: function () {
            ea.table.render({
                ...
                cols: [[
                    ...
                    {field: 'site_id', minWidth: 0, title: '站点',search:'select',selectList:{'name':'/gladmin/website.site/getcategory'},dong:true},
