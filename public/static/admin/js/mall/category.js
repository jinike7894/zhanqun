define(["jquery", "easy-admin"], function ($, ea) {
    ...
    var init = {
        ...
        delete_url: 'mall.category/delete',
        show_url: 'mall.category/show',
    };
    ...
    var Controller = {
        ...
        index: function () {
            ea.table.render({
                ...
                cols: [[
                    ...
                    {field: 'title', minWidth: 0, title: '类别名称'},
        ...
        show: function () {
            var init = {
                table_elem: '#currentTable',
                table_render_id: 'currentTableRenderId',
                index_url: 'data.category/show?id=' + getUrlParam('id') + '&date=' + getUrlParam('date'),
            };
            ea.table.render({
                init: init,
                toolbar: ['refresh'],
