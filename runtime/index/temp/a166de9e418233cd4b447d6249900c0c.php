<?php /*a:2:{s:61:"/www/wwwroot/zhanqun.dahuangua.com/view/index/novel/info.html";i:1732117464;s:63:"/www/wwwroot/zhanqun.dahuangua.com/view/index/novel/header.html";i:1732119342;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
">连载</span>
                        ...
                        <div class="contentAuthor">
                            ...
                            <span class="contentA fontWeight">更新至<?php echo htmlentities(novelNum($info['id'])); ?>章</span>
                        ...
                        <div class="contentRead">
                            <div class="contentReadBox">
                                <img src="/static/novel/images/Book_Open.svg" />
                                阅读 <span class="contentK"><?php echo htmlentities(eyek($info['eye'])); ?>K</span>
                            </div>
                            <div class="contentReadBox">
                                <img src="/static/novel/images/Star.svg" />
                                收藏<span><?php echo htmlentities(eyek($info['shoucang'])); ?>K</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <?php else: ?>
                <a href="/novel/chapter/<?php echo htmlentities($channel); ?>.html?chapter_id=<?php echo htmlentities($novelcountid); ?>">
            ...
            <div class="mulv">
                <div class="mulvTop">
                    <div class="mulvtext">目录—更新至<?php echo htmlentities(novelNum($info['id'])); ?>章</div>
                    <div class="mulvRight">
                        <img class="zhengxu" id="imgToChange" src="/static/novel/images/zhengxu.svg" />
                ...
                <div class="mulvPz">
                    ...
                    <div class="pzList">
                        <a href="/novel/chapter/<?php echo htmlentities($channel); ?>.html?chapter_id=<?php echo htmlentities($item['id']); ?>">
