<?php /*a:1:{s:62:"/www/wwwroot/zhanqun.dahuangua.com/view/index/index/index.html";i:1732058242;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div class="index_page">
        ...
        <div class="index_nav">
            ...
            <a class="index_nav_li" href="./<?php echo htmlentities($channel); ?>.html?adcateid=<?php echo htmlentities($item['id']); ?>" ><?php echo htmlentities($item['title']); ?></a>
            <?php endforeach; endif; else: echo "" ;endif; ?>
        </div>
        <!-- 九宫格 -->
        ...
        <div class="index-jiugonggeTxt">
            ...
            <div class="index_jiugonggeTxt_text ad"
            data-id="<?php echo htmlentities($item['id']); ?>" 
            data-channel="<?php echo htmlentities($channel); ?>" 
            data-site="<?php echo htmlentities($site_id); ?>"
            data-url="<?php echo htmlentities($item['androidurl']); ?>"
            ><?php echo htmlentities($item['name']); ?></div>
            <?php endforeach; endif; else: echo "" ;endif; ?>
        ...
        <div class="index_news">
            ...
            <div class="index_news_line">
                ...
                <img src="<?php echo htmlentities($item['pic']); ?>" class="index_news_line_right_img" onerror="this.src='/static/images/loading_img_bg_default.jpg';" >
            ...
            <div class="index_news_chigua">
                ...
                <div class="index_news_chigua_imgBox">
                    <?php if(is_array($items['pic']) || $items['pic'] instanceof \think\Collection || $items['pic'] instanceof \think\Paginator): $i = 0; $__LIST__ = $items['pic'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$it): $mod = ($i % 2 );++$i;?>
                    <img src="<?php echo htmlentities($it); ?>" class="index_news_chigua_img"  onerror="this.src='/static/images/loading_img_bg_default.jpg';">
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </div>
                <div class="index_news_line_left_BottomBox">
        ...
        <div class="index_realPerson">
            ...
            <div class="index_realperson_box ad"
            data-id="<?php echo htmlentities($item['id']); ?>" 
            data-channel="<?php echo htmlentities($channel); ?>" 
            data-site="<?php echo htmlentities($site_id); ?>"
            data-url="<?php echo htmlentities($item['androidurl']); ?>"
            >
                <div class="index_realPerson_leftBox">
                    <div class="index_realPerson_left">
                        <img src="<?php echo htmlentities($item['img']); ?>" class="index_realPerson_leftImg" onerror="this.src='/static/images/loading_img_bg_default.jpg';">
                ...
                <div class="index_realPerson_right">
                    ...
                    <div class="index_realPerson_imgBox">
                        ...
                        <img src="<?php echo htmlentities($pic); ?>" class="index_realPerson_img" onerror="this.src='/static/images/loading_img_bg_default.jpg';">
                        <?php endforeach; endif; else: echo "" ;endif; ?>
        ...
        >
            <div class="index_alive_box">
                ...
                <div class="index_alive_imgbox">
                    <img src="<?php echo htmlentities($item['img']); ?>" class="index_alive_img" onerror="this.src='/static/images/loading_img_bg_default.jpg';">
                    <!-- 直播观看人数 -->
            ...
            <a href="">
                <div class="index_news_chigua">
                    ...
                    <div class="index_chiguaRead_img">
                        ...
                        <img src="<?php echo htmlentities($items['pic'][0]); ?>" class="index_chiguaRead_left" onerror="this.src='/static/images/loading_img_bg_default.jpg';">
                        ...
                        <div class="index_chiguaRead_rightBox">
                            ...
                            <img src="<?php echo htmlentities($item); ?>" class="index_chiguaRead_rightImg" onerror="this.src='/static/images/loading_img_bg_default.jpg';">
                            <?php endforeach; endif; else: echo "" ;endif; ?>
        ...
        <a href="/novel/info/<?php echo htmlentities($channel); ?>.html?id=<?php echo htmlentities($item['id']); ?>">
            <div class="index_read">
                ...
                <div class="index_read_right">
                    <img src="<?php echo htmlentities($item['pic']); ?>" class="index_read_rightImg" onerror="this.src='/static/images/loading_img_bg_default.jpg';">
        ...
        <a href="/comics/info/<?php echo htmlentities($channel); ?>.html?id=<?php echo htmlentities($item['id']); ?>" class="index_alive_a">
            <div class="index_cartoon_box">
                ...
                <div class="index_cartoon_imgbox">
                    <img src="<?php echo htmlentities($item['pic']); ?>" class="index_cartoon_img" onerror="this.src='/static/images/loading_img_bg_default.jpg';">
                    <!-- top -->
    ...
    <div class="index_page">
        ...
        <div>
            ...
            <img src="<?php echo htmlentities($item['img']); ?>" class="index_advertisement ad"
            data-id="<?php echo htmlentities($item['id']); ?>" 
            data-channel="<?php echo htmlentities($channel); ?>" 
            data-site="<?php echo htmlentities($site_id); ?>"
            data-url="<?php echo htmlentities($item['androidurl']); ?>" onerror="this.src='/static/images/loading_img_bg_default.jpg';"
            >
            <?php endforeach; endif; else: echo "" ;endif; ?>
        </div>
        ...
        <a href="">
            <div class="index_news_chigua">
                ...
                <div class="index_news_chigua_imgBox">
                    <?php if(is_array($items['pic']) || $items['pic'] instanceof \think\Collection || $items['pic'] instanceof \think\Paginator): $i = 0; $__LIST__ = $items['pic'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
                    <img src="<?php echo htmlentities($item); ?>" class="index_news_chigua_img" onerror="this.src='/static/images/loading_img_bg_default.jpg';">
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </div>
                <div class="index_news_line_left_BottomBox">
                    <div class="index_news_line_left_BottomBox_videoBtn">吃瓜</div>
    ...
    <div class="index_cartoon">
        ...
        <a href="" class="index_alive_a">
            <div class="index_cartoon_box">
                <!-- 图片盒子 -->
                <div class="index_cartoon_imgbox">
                    <img src="<?php echo htmlentities($item['pic'][0]); ?>" class="index_cartoon_img" onerror="this.src='/static/images/loading_img_bg_default.jpg';">
