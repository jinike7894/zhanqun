<?php /*a:1:{s:47:"C:\wwwroot\zhanqun\view\index\comics\index.html";i:1732200618;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div id="page">
        ...
        <div class="contentBox" style="padding-top: 90px;">
            ...
            <!-- 导航栏 -->
            <div class="lableList">
                <a href="/comics/<?php echo htmlentities($channel); ?>.html?type=renqi"><div class="lable <?php if($types == 1): ?>lable_active<?php endif; ?>">人气榜</div></a>
...
" <?php endif; ?>><?php echo htmlentities($index); ?></div> <?php echo htmlentities(getNovelCate($item['cate_id'])); ?>
            ...
            <div class="chooseMl" style="margin-top: 10px;">
                ...
                <?php if(is_array($novelCate) || $novelCate instanceof \think\Collection || $novelCate instanceof \think\Paginator): $i = 0; $__LIST__ = $novelCate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
                <a href="/comics/<?php echo htmlentities($channel); ?>.html?cate_id=<?php echo htmlentities($item['id']); ?>"><div class="choosePage <?php if($cate_id == $item['id']): ?>choosePage choosePage_active<?php endif; ?>"><?php echo htmlentities($item['title']); ?></div></a>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </div>
