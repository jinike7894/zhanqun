<?php /*a:1:{s:63:"/www/wwwroot/zhanqun.dahuangua.com/view/index/comics/index.html";i:1732119260;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div id="page">
        ...
        <div class="header">
            <div class="headerBox">
                <div class="logoBox">
                    ...
                    <!-- <img src="/static/comics/img/logoTxt.png" class="header_logoTxt"> -->
        ...
        <div class="contentBox">
            ...
            <div class="index-jiugonggeTxt" style="margin-bottom: 8px;">
                ...
                <?php endforeach; endif; else: echo "" ;endif; ?>
                <!-- <div class="index_jiugonggeTxt_text index_jiugonggeTxt_hotColor" style="background: #171818;">
                    <img src="/static/comics/img/hot.png" class="index_jiugongge_hot">国产精品
                </div>
                <div class="index_jiugonggeTxt_text" style="background: #171818;">国产精品</div>
                <div class="index_jiugonggeTxt_text" style="background: #171818;">国产精品</div>
                <div class="index_jiugonggeTxt_text" style="background: #171818;">国产精品</div>
                <div class="index_jiugonggeTxt_text" style="background: #171818;">国产精品</div>
                <div class="index_jiugonggeTxt_text" style="background: #171818;">国产精品</div>
            ...
            <div class="home_LabelBox">
                <?php if(is_array($img_font_ad) || $img_font_ad instanceof \think\Collection || $img_font_ad instanceof \think\Paginator): $i = 0; $__LIST__ = $img_font_ad;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
                    ...
                    data-url="<?php echo htmlentities($item['androidurl']); ?>">
                        ...
                        <img src="/static/comics/img/yellowRight.png" class="home_LabelContent_title_yellowRight">
                    </div>
                  <?php endforeach; endif; else: echo "" ;endif; ?>
            ...
            <!-- 导航栏 -->
            <div class="lableList">
                <a href="/comics/<?php echo htmlentities($channel); ?>.html?type=renqi"><div class="lable">人气榜</div></a>
                <a href="/comics/<?php echo htmlentities($channel); ?>.html?type=tuijian"><div class="lable">推荐榜</div></a>
                <a href="/comics/<?php echo htmlentities($channel); ?>.html?type=shoucang"><div class="lable">收藏榜</div></a>
                <a href="/comics/<?php echo htmlentities($channel); ?>.html?type=resou"><div class="lable">热搜榜</div></a>
            </div>
...
" <?php endif; ?>><?php echo htmlentities($index); ?></div> <?php echo htmlentities(getNovelCate($item['cate_id'])); ?>
            ...
            <div class="chooseMl" style="margin-top: 10px;">
                ...
                <?php if(is_array($novelCate) || $novelCate instanceof \think\Collection || $novelCate instanceof \think\Paginator): $i = 0; $__LIST__ = $novelCate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
                <a href="/comics/<?php echo htmlentities($channel); ?>.html?cate_id=<?php echo htmlentities($item['id']); ?>"><div class="choosePage"><?php echo htmlentities($item['title']); ?></div></a>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </div>
