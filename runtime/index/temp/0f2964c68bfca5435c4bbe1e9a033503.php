<?php /*a:2:{s:50:"C:\wwwroot\zhanqun\view\index\image\searchres.html";i:1732704230;s:48:"C:\wwwroot\zhanqun\view\index\image\header2.html";i:1732271101;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div id="page">
        ...
        <div class="contentBox">
            ...
            <div class="home_searchBox">
                <?php if(is_array($novelCate) || $novelCate instanceof \think\Collection || $novelCate instanceof \think\Paginator): $i = 0; $__LIST__ = $novelCate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
                <a href="/image/<?php echo htmlentities($channel); ?>.html?cate_id={}">
        ...
        <div class="contentBox">
            <div class="tj_nav">搜索结果——<?php echo htmlentities($query); ?></div>
            <div class="hotList">
