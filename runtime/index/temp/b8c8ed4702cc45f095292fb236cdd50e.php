<?php /*a:2:{s:52:"D:\phpEnv\www\pron\view\index\index\category_pc.html";i:1720783977;s:44:"D:\phpEnv\www\pron\view\index\pc_header.html";i:1720783977;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
<meta charset="UTF-8">
...
<a href="/"><div class="v-s-li-nav-link-vs_4a48f752db41520564b84da1f2631937">首页</div></a>
...
<a href="/category/<?php echo htmlentities($channel); ?>.html?category_id=<?php echo htmlentities($menu['id']); ?>"><div class="v-s-li-nav-link-vs_4a48f752db41520564b84da1f2631937 <?php if($category_id == $menu['id']): ?>nav-menu-selected<?php endif; ?>"><?php echo htmlentities($menu['title']); ?></div></a>
...
<a href="/category/<?php echo htmlentities($channel); ?>.html?category_id=<?php echo htmlentities($category_id); ?>&category_child_id=<?php echo htmlentities($cmenu['id']); ?>" target="_self"><div class="v-s-li-nav-link-tag  <?php if($category_child_id == $cmenu['id']): ?>nav-category-tag-selected<?php endif; ?>"><?php echo htmlentities($cmenu['title']); ?></div></a>
<?php endforeach; endif; else: echo "" ;endif; ?>
</div>
