<?php /*a:1:{s:51:"C:\wwwroot\zhanqun\view\index\video\vod_mobile.html";i:1731924758;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
<script type="text/javascript" src="<?php echo htmlentities($jscsscdn); ?>/static/js/jquery-2.2.4.min.js"></script>
<style type="text/css">
    * {margin: 0; padding: 0;}
    html, body {
        width: 100%;
  ...
  <script type="text/javascript" src="<?php echo htmlentities($jscsscdn); ?>/static/js/hls.min.js"></script>
  <script type="text/javascript" src="<?php echo htmlentities($jscsscdn); ?>/static/js/DPlayer.min.js"></script>
<script>
//之性质
