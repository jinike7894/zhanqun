<?php /*a:2:{s:50:"D:\wamp\www\pron\view\index\index\category_pc.html";i:1692100915;s:42:"D:\wamp\www\pron\view\index\pc_header.html";i:1692084932;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
<meta charset="UTF-8">
...
<a href="<?php echo url('index/category',['category_id'=>$category_id,'category_child_id'=>$cmenu['id']]); ?>" target="_self"><div class="v-s-li-nav-link-tag  <?php if($category_child_id == $cmenu['id']): ?>nav-category-tag-selected<?php endif; ?>"><?php echo htmlentities($cmenu['title']); ?></div></a>
<?php endforeach; endif; else: echo "" ;endif; ?>
</div>
