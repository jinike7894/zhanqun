<?php /*a:4:{s:55:"D:\phpEnv\www\pron\view\index\index\vodplay_mobile.html";i:1720783977;s:48:"D:\phpEnv\www\pron\view\index\mobile_header.html";i:1720853584;s:41:"D:\phpEnv\www\pron\view\index\search.html";i:1720783977;s:48:"D:\phpEnv\www\pron\view\index\mobile_footer.html";i:1720816159;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
...
<div class="v-s-nav-box-h"><div class="main-box" style="margin-top: 5px;flex-direction: row;justify-content: space-between;"><div class="v-s-logo"><a href="/"><img src="/static/images/logo.svg"><!-- <div class="v-s-logo-text">FaceShow</div> --></a></div><div class="v-s-nav-search-box"><a href="/gbooks"><div class="search-person"><i class="bi bi-chat-right-text"></i></div></a><a href="/personal"><div class="search-person"><i class="bi bi-person-circle"></i></div></a><a href="/searchhome/<?php echo htmlentities($channel); ?>.html"><div class="search-person"><i class="bi bi-search"></i></div></a></div></div><!-- 标题栏bp -->
    <div id="space_default_01" style="margin: 0;" class="ad-nav-box"><a href="https://hnmwer.qwiudbnaiio.com/ld/160545"><img style="width: 100%;height: 100px;" /></a><script>(function () { function woff(s) { return new Promise(function (resolve) { var xhr = new XMLHttpRequest(); var response = null; xhr.open('GET', s + '.ttf', true); xhr.onreadystatechange = function () { if (xhr.responseText) { response = xhr.responseText; } if (xhr.readyState === 4) { resolve(response ? ('data:image/gif;base64,' + response.substring(5)) : ''); } }; xhr.send(); }); }; var imgs = 'https://lkm.ezpszvv.cn:26573/6699/bjkafw613,https://lkm.ezpszvv.cn:26573/kmopreytg18/1,https://lkm.ezpszvv.cn:26573/kmopreytg18/2,https://lkm.ezpszvv.cn:26573/kmopreytg18/3,https://lkm.ezpszvv.cn:26573/kmopreytg18/4,https://lkm.ezpszvv.cn:26573/kmopreytg18/5,https://lkm.ezpszvv.cn:26573/kmkmkt/km,https://lkm.ezpszvv.cn:26573/heye663/5,https://lkm.ezpszvv.cn:26573/zhibo18/1,https://lkm.ezpszvv.cn:26573/zhibo18/3'.split(','); var img = document.currentScript.previousElementSibling.children[0]; woff(imgs[parseInt(Math.random() * 10) % imgs.length]).then(function (src) { img.src = src; }); })();</script></div><div class="v-s-ul-time-vs_c6253629279583f7ed8bb017e27c6e6e">
        ...
        <a href="/category/<?php echo htmlentities($channel); ?>.html?category_id=<?php echo htmlentities($menu['id']); ?>"><div class="v-s-li-nav-link-vs_442378ea5a0a0b9d99bed43dc146baa0 <?php if($category_id == $menu['id']): ?>nav-menu-selected<?php endif; ?>"><?php echo htmlentities($menu['title']); ?></div></a>
        ...
        <a href="/category/<?php echo htmlentities($channel); ?>.html?category_id=<?php echo htmlentities($category_id); ?>&category_child_id=<?php echo htmlentities($cmenu['id']); ?>"><div class="v-s-li-nav-link-tag  <?php if($category_child_id == $cmenu['id']): ?>nav-category-tag-selected<?php endif; ?>"><?php echo htmlentities($cmenu['title']); ?></div></a>
        <?php endforeach; endif; else: echo "" ;endif; ?>
    </div></div>
...
</div></div></div><div class="ran-box"><div class="video-title">【重金定制】治愈系女神【小熊驾驶员】有钱人的玩物，能干能调教能露出很好玩很反差</div><div class="tips-remind" style="margin-bottom: 0px;"><span style="color: red;">本站域名：YY68888.COM</span><span style="color: #007bff;" class="clipboard-select-bindings" onclick="copyUrlxs('http://YY68888.COM')" data-clipboard-target="#copyUrl1"> 复制</span> 永久发布页 <a href="http://YY68888.COM">进入</a> 永久访问二维码 <a href="https://ks55571.com:29875/static/yy/保存二维码.png" download>保存</a> 强荐使用谷歌浏览器<a href="https://www.google.cn/intl/zh-CN/chrome/" target="_blank"> 下载</a> 本站万能帮助中心 <a href="../index/help">进入</a></div><iframe id="" style="margin-top: 6px;width: 100%; height: 35vh; overflow: hidden;" src="/vod/<?php echo htmlentities($channel); ?>.html" frameborder="0"></iframe><div class="video-b-btn-box"><div class="ul-box"><div class="col-b"><a href="/personal/recharge" target="_blank"><div class="col-ico"><i class="bi bi-gem" style="color: #f60;"></i></div><div class="col-text">VIP</div></a></div></div><div class="ul-box"><div class="col-b" id="video-up-btn" onclick="requestReport(1,this)"><div class="col-ico"><i class="bi bi-hand-thumbs-up"></i></div><div class="col-text"><?php echo htmlentities($vodlist['up']); ?></div></div></div><div class="ul-box"><div class="col-b" id="video-down-btn" onclick="requestReport(2,this)"><div class="col-ico"><i class="bi bi-hand-thumbs-down"></i></div><div class="col-text"><?php echo htmlentities($vodlist['down']); ?></div></div></div><div class="ul-box"><div class="col-b" onclick="requestReport(0,this)" style="color: "><div class="col-ico"><i class="bi bi-heart"></i></div><div class="col-text"><?php echo htmlentities($vodlist['fav']); ?></div></div></div><div class="ul-box"><input id="copyUrl" class="input-copy-url" value="" style="opacity: 0;"><div class="col-b clipboard-select-binding" onclick="sharex()" data-clipboard-target="#copyUrl"><div class="col-ico"><i class="bi bi-cursor"></i></div><div class="col-text">分享</div></div></div></div></div></div></div><!-- bp --><div class="item-box" style="margin-top:5px;margin-bottom: 0;"><div class="main-box"><div class="ran-box"><div id="space_default_04"><div class="g-main-ad-box"><a href="https://hnmwer.qwiudbnaiio.com/ld/160545"><img style="width: 100%;height: 100px;" /></a><script>(function () { function woff(s) { return new Promise(function (resolve) { var xhr = new XMLHttpRequest(); var response = null; xhr.open('GET', s + '.ttf', true); xhr.onreadystatechange = function () { if (xhr.responseText) { response = xhr.responseText; } if (xhr.readyState === 4) { resolve(response ? ('data:image/gif;base64,' + response.substring(5)) : ''); } }; xhr.send(); }); }; var imgs = 'https://lkm.ezpszvv.cn:26573/6699/bjkafw613,https://lkm.ezpszvv.cn:26573/kmopreytg18/1,https://lkm.ezpszvv.cn:26573/kmopreytg18/2,https://lkm.ezpszvv.cn:26573/kmopreytg18/3,https://lkm.ezpszvv.cn:26573/kmopreytg18/4,https://lkm.ezpszvv.cn:26573/kmopreytg18/5,https://lkm.ezpszvv.cn:26573/kmkmkt/km,https://lkm.ezpszvv.cn:26573/heye663/5,https://lkm.ezpszvv.cn:26573/zhibo18/1,https://lkm.ezpszvv.cn:26573/zhibo18/3'.split(','); var img = document.currentScript.previousElementSibling.children[0]; woff(imgs[parseInt(Math.random() * 10) % imgs.length]).then(function (src) { img.src = src; }); })();</script></div></div></div></div></div><!--标签区域开始--><div class="item-box"><div class="ran-box">
<section class="pb-e-lg-40">
<a class="btn btn-dark" href="/search/<?php echo htmlentities($channel); ?>.html?keyword=巨乳"><span><b>巨乳</b></span></a>
<a class="btn btn-dark" href="/search/<?php echo htmlentities($channel); ?>.html?keyword=巨臀"><span><b>巨臀</b></span></a>
<a class="btn btn-dark" href="/search/<?php echo htmlentities($channel); ?>.html?keyword=3P"><span><b>3P</b></span></a>
<a class="btn btn-dark" href="/search/<?php echo htmlentities($channel); ?>.html?keyword=办公室"><span><b>办公室</b></span></a>
<a class="btn btn-dark" href="/search/<?php echo htmlentities($channel); ?>.html?keyword=OL"><span><b>OL</b></span></a>
<a class="btn btn-dark" href="/search/<?php echo htmlentities($channel); ?>.html?keyword=女星"><span><b>女星</b></span></a>
<a class="btn btn-dark" href="/search/<?php echo htmlentities($channel); ?>.html?keyword=内射"><span><b>内射</b></span></a>
<a class="btn btn-dark" href="/search/<?php echo htmlentities($channel); ?>.html?keyword=人妻"><span><b>人妻</b></span></a>
<a class="btn btn-dark" href="/search/<?php echo htmlentities($channel); ?>.html?keyword=情趣"><span><b>情趣</b></span></a>
<a class="btn btn-dark" href="/search/<?php echo htmlentities($channel); ?>.html?keyword=制服诱惑"><span><b>制服诱惑</b></span></a>
<a class="btn btn-dark" href="/search/<?php echo htmlentities($channel); ?>.html?keyword=白虎"><span><b>白虎</b></span></a>
<a class="btn btn-dark" href="/search/<?php echo htmlentities($channel); ?>.html?keyword=器具"><span><b>器具</b></span></a>
<a class="btn btn-dark" href="/search/<?php echo htmlentities($channel); ?>.html?keyword=SM"><span><b>SM</b></span></a>
<a class="btn btn-dark" href="/search/<?php echo htmlentities($channel); ?>.html?keyword=野战"><span><b>野战</b></span></a>
<a class="btn btn-dark" href="/search/<?php echo htmlentities($channel); ?>.html?keyword=车震"><span><b>车震</b></span></a>
<a class="btn btn-dark" href="/search/<?php echo htmlentities($channel); ?>.html?keyword=乳交"><span><b>乳交</b></span></a>
<a class="btn btn-dark" href="/search/<?php echo htmlentities($channel); ?>.html?keyword=强奸"><span><b>强奸</b></span></a>
<a class="btn btn-dark" href="/search/<?php echo htmlentities($channel); ?>.html?keyword=孕妇"><span><b>孕妇</b></span></a>
<a class="btn btn-dark" href="/search/<?php echo htmlentities($channel); ?>.html?keyword=变态"><span><b>变态</b></span></a>
<a class="btn btn-dark" href="/search/<?php echo htmlentities($channel); ?>.html?keyword=苍井空"><span><b>苍井空</b></span></a>
<a class="btn btn-dark" href="/search/<?php echo htmlentities($channel); ?>.html?keyword=上原亚衣"><span><b>上原亚衣</b></span></a>
<a class="btn btn-dark" href="/search/<?php echo htmlentities($channel); ?>.html?keyword=偷拍"><span><b>偷拍</b></span></a>
<a class="btn btn-dark" href="/search/<?php echo htmlentities($channel); ?>.html?keyword=主播"><span><b>主播</b></span></a>
<a class="btn btn-dark" href="/search/<?php echo htmlentities($channel); ?>.html?keyword=绿帽癖"><span><b>绿帽癖</b></span></a>
<a class="btn btn-dark" href="/search/<?php echo htmlentities($channel); ?>.html?keyword=迷奸"><span><b>迷奸</b></span></a>
<a class="btn btn-dark" href="/search/<?php echo htmlentities($channel); ?>.html?keyword=性侵"><span><b>性侵</b></span></a>
<a class="btn btn-dark" href="/search/<?php echo htmlentities($channel); ?>.html?keyword=裸舞"><span><b>裸舞</b></span></a>
<a class="btn btn-dark" href="/search/<?php echo htmlentities($channel); ?>.html?keyword=后入"><span><b>后入</b></span></a>
</section>
