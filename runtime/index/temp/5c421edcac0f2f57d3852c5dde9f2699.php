<?php /*a:1:{s:64:"/www/wwwroot/zhanqun.dahuangua.com/view/index/comics/search.html";i:1731972618;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <link rel="stylesheet" href="/static/comics/css/search.css">
    ...
    <div id="searchpage">
        ...
        <div class="header">
            ...
            <div class="search_input">
                <a href="/comics/<?php echo htmlentities($channel); ?>.html"><img src="/static/comics/img/back.png" class="search_back"></a>
                <div  class="search_inputBox">
                    <input class="search_input_input" />
                    <img src="/static/comics/img/search.png" class="header_search">
                
                        <div class="search_searchBtn" data-url="/comics/searchres/<?php echo htmlentities($channel); ?>.html">搜索</div>
                </div>
        ...
        <div class="contentBox">
            ...
            <div class="search_hot">
                <div class="search_hotLeft">
                    ...
                    <a href="/comics/searchres/<?php echo htmlentities($channel); ?>.html?query=<?php echo htmlentities($item['title']); ?>">
                        <div class="search_hotBox">
                            <div class="search_hotNum  <?php if(($index == 1) OR ($index == 2) OR ($index == 3)): ?>serach_hotOne<?php endif; ?>">
                                <?php echo htmlentities($index); ?>
                            </div>
                            <div class="search_hotTxt   <?php if(($index == 1) OR ($index == 2) OR ($index == 3)): ?>serach_hotOneTxt<?php endif; ?>">
