<?php /*a:2:{s:48:"C:\wwwroot\zhanqun\view\index\chigua\search.html";i:1732260186;s:49:"C:\wwwroot\zhanqun\view\index\chigua\header1.html";i:1732259553;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div id="searchpage">
        ...
        <div class="header">
            <div class="headerBox">
                ...
                <img src="/static/chigua/img/collectBtn.png" class="header_collect">

            </div>
            <div class="search_input" >
                <a href="/chigua/<?php echo htmlentities($channel); ?>.html"><img src="/static/chigua/img/back.png" class="search_back"></a>
                <div  class="search_inputBox">
                    <input class="search_input_input" />
                    <img src="/static/chigua/img/search.png" class="header_search">
                    <div style="color: #000;">
                        <div class="search_searchBtn" data-url="/chigua/searchres/<?php echo htmlentities($channel); ?>.html">搜索</div>
                    </div>
        ...
        <div class="contentBox" style="padding-top: 90px;">
            ...
            <div class="search_hot">
                <div class="search_hotLeft">
                    ...
                    <a href="/chigua/searchres/<?php echo htmlentities($channel); ?>.html?query=<?php echo htmlentities($item['title']); ?>">
...
<script src="/static/chigua/js/swiper-bundle.min.js"></script>
<script>
