<?php /*a:1:{s:45:"C:\wwwroot\zhanqun\view\index\novel\read.html";i:1732187416;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
...
<body>
    ...
    <div id="page">
      ...
      <!-- 广告开始 -->
        ...
        <div class="contentBox" style="background: none;padding-top: 90px;">
     ...
     <!-- 广告结束 -->
        ...
        <!-- <div style="width: 100%;position: fixed;background: #000;top: 0;"> -->
            <!-- 返回栏 -->
            <div class="nav">
                <a href="/novel/info/<?php echo htmlentities($channel); ?>.html?id=<?php echo htmlentities($novel['id']); ?>" class="left">
       ...
       <!-- 中部广告结束-->
        ...
        <div class="lableList paddingRead" style="margin: 10px;">
            <a href="/novel/info/<?php echo htmlentities($channel); ?>.html?id=<?php echo htmlentities($novel['id']); ?>" class="lable flex" style="height:36px;">
            ...
            <a href="/novel/chapter/<?php echo htmlentities($channel); ?>.html?chapter_id=<?php echo htmlentities($pre['id']); ?>" class="lable flex" style="height:36px;"><img src="/static/images/chevron_Left.svg" /><span style="margin-left: 5px;">上一章</span>
            </a>
            <a href="/novel/chapter/<?php echo htmlentities($channel); ?>.html?chapter_id=<?php echo htmlentities($next['id']); ?>" style="height:36px;" class="lable flex"><span>下一章</span><img src="/static/images/right.svg"
    ...
    <div class="popupRead">
        ...
        <div class="mulv">
            ...
            <div class="mulvTop">
                ...
                <div class="mulvtext">目录—更新至<?php echo htmlentities($catalogcount); ?>章</div>
                <div class="mulvRight">
            ...
            <div class="mulvPz">
                ...
                <a  href="/novel/chapter/<?php echo htmlentities($channel); ?>.html?chapter_id=<?php echo htmlentities($index['id']); ?>" class="pzList">
