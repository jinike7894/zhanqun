...
<div id="page">
      <!-- 广告开始 -->
        ...
        <div class="contentBox" style="padding-top: 90px;background: none;">
    ...
    <!-- <div style="width: 100%;position: fixed;background: #000;top: 0;"> -->
        ...
        <div class="nav">
            <a href="/comics/info/<?php echo htmlentities($channel); ?>.html?id=<?php echo htmlentities($novel['id']); ?>" class="left">
                <img class="leftBtn" src="/static/comics/img/fqbtn_left.png" style="width: 16px;
    height: 16px;"/>
                <div class="leftName" style="color: #FA2B24;">漫画阅读</div>
            </a>
            <div class="right">
