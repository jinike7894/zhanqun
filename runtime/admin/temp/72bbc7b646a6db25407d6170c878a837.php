<?php /*a:2:{s:57:"C:\wwwroot\zhanqun\view\admin\mall\channel_codes\add.html";i:1731147769;s:49:"C:\wwwroot\zhanqun\view\admin\layout\default.html";i:1730802670;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layuimini-container">
    <form id="app-form" class="layui-form layuimini-form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <select name="site_category_id" lay-verify="required" data-select="<?php echo url('website.category/getcategory'); ?>"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                ...
                <?php foreach($hours as $hour): ?>
                    <option value="<?php echo htmlentities($hour); ?>"><?php echo htmlentities($hour); ?></option>
                <?php endforeach; ?>
                </select>
