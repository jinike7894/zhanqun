<?php /*a:2:{s:68:"/www/wwwroot/zhanqun.dahuangua.com/view/admin/mall/product/edit.html";i:1731622302;s:65:"/www/wwwroot/zhanqun.dahuangua.com/view/admin/layout/default.html";i:1730831472;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <form id="app-form" class="layui-form layuimini-form">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <select name="pid" lay-verify="required" data-select="<?php echo url('mall.type/index'); ?>" data-fields="id,title"  data-value="<?php echo htmlentities((isset($row['pid']) && ($row['pid'] !== '')?$row['pid']:'')); ?>"></select>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <select name="cid" lay-verify="required" data-select="<?php echo url('mall.category/index'); ?>" data-fields="id,title" data-value="<?php echo htmlentities((isset($row['cid']) && ($row['cid'] !== '')?$row['cid']:'')); ?>"></select>
            </div>
        </div>
        <!-- <div class="layui-form-item">
            <label class="layui-form-label">到期日期</label>
            <div class="layui-input-block">
                <input type="text" name="due_date" readonly="true" id="due_date" value="<?php echo htmlentities((isset($row['due_date']) && ($row['due_date'] !== '')?$row['due_date']:'')); ?>" class="layui-input" lay-verify="" placeholder="请输入到期日期">
            </div>
        </div> -->
        <div class="layui-form-item">
		...
		<div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <!--<input type="text" name="name" class="layui-input" lay-verify="required" placeholder="请输入广告位名称" value="<?php echo htmlentities((isset($row['name']) && ($row['name'] !== '')?$row['name']:'')); ?>">-->
                <textarea name="name" class="layui-textarea" placeholder="请输入广告位名称,匹配城市请用{city}占位"><?php echo htmlentities((isset($row['name']) && ($row['name'] !== '')?$row['name']:'')); ?></textarea>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="k_name" class="layui-input" lay-verify="required" placeholder="请输入客户名称" value="<?php echo htmlentities((isset($row['k_name']) && ($row['k_name'] !== '')?$row['k_name']:'')); ?>">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <select name="url_type" id="url_type"  disabled  lay-filter="url_type">
                    <option value="1"   <?php if($row['url_type'] == 1): ?> selected <?php endif; ?> >站内跳转</option>
                    <option value="0"  <?php if($row['url_type'] == 0): ?> selected <?php endif; ?> >站外跳转</option>
                </select>
            </div>
        </div>
        <?php if($row['url_type'] == 0): ?>
        <div class="layui-form-item urls" >
            <label class="layui-form-label">链接</label>
            <div class="layui-input-block">
                <input type="text" name="androidurl" class="layui-input" 
                    placeholder="请输入产品链接,必须以http://或者https://开头" value="<?php echo htmlentities((isset($row['androidurl']) && ($row['androidurl'] !== '')?$row['androidurl']:'')); ?>" />
            </div>
        </div>
        <?php endif; ?>
        <!-- <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <select name="is_home" id="is_home">
                    <option value="0" <?php if($row['is_home'] == 0): ?>selected<?php endif; ?>>否</option>
                    <option value="1" <?php if($row['is_home'] == 1): ?>selected<?php endif; ?>>是</option>
                </select>
            </div>
        </div> -->
        <!-- <div class="layui-form-item">
        ...
        <!-- <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <select name="ad_position" id="ad_position">
                    <option value="0" <?php if($row['ad_position'] == 0): ?>selected<?php endif; ?>>默认</option>
                    <option value="1" <?php if($row['ad_position'] == 1): ?>selected<?php endif; ?>>顶部</option>
                    <option value="2" <?php if($row['ad_position'] == 2): ?>selected<?php endif; ?>>底部</option>
                </select>
            </div>
        </div> -->
        <!-- <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <select name="is_browser" id="is_browser">
                    <option value="0" <?php if($row['is_browser'] == 0): ?>selected<?php endif; ?>>跳转广告</option>
                    <option value="1" <?php if($row['is_browser'] == 1): ?>selected<?php endif; ?>>直播内页</option>
                    <option value="2" <?php if($row['is_browser'] == 2): ?>selected<?php endif; ?>>约炮内页</option>
                    <option value="3" <?php if($row['is_browser'] == 3): ?>selected<?php endif; ?>>春药内页</option>
                </select>
            </div>
        </div> -->
...
<!--         
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block layuimini-upload">
                <input name="pics" class="layui-input layui-col-xs6"  placeholder="请上传产品详细图片(3~6张)" value="<?php echo htmlentities((isset($row['pics']) && ($row['pics'] !== '')?$row['pics']:'')); ?>">
                <div class="layuimini-upload-btn">
