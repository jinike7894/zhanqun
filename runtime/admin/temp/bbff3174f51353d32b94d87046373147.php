<?php /*a:2:{s:53:"C:\wwwroot\zhanqun\view\admin\mall\img_cate\edit.html";i:1732113987;s:49:"C:\wwwroot\zhanqun\view\admin\layout\default.html";i:1732110801;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layuimini-container">
    <form id="app-form" class="layui-form layuimini-form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="pid" class="layui-input"  placeholder="请输入子分类" value="<?php echo htmlentities((isset($row['pid']) && ($row['pid'] !== '')?$row['pid']:'')); ?>">
            </div>
        </div>
